...
class InsertMovie extends Connection 
{
    ...
    public function __construct(Array $data) // Suposo que el que entra pel formulari es passarà a Array
    {
        parent::__construct();
        $this->data = $data;
    }
    ...
    private function _getIdMovie(): Array // Nota per Albert: no recordo el tipus que retorna el fetch, crec que array
    {
